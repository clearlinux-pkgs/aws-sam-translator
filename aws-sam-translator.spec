...
Source0  : https://files.pythonhosted.org/packages/f2/76/2b5c76cc8ae4d3373a793059b2073af1bb5f37189532dacd4788d2d142d3/aws-sam-translator-1.42.0.tar.gz
...
%prep
%setup -q -n aws-sam-translator-1.42.0
cd %{_builddir}/aws-sam-translator-1.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1637765806
...
cp %{_builddir}/aws-sam-translator-1.42.0/LICENSE %{buildroot}/usr/share/package-licenses/aws-sam-translator/9ff23d505de81a8185554e10c611378b8698bc71
