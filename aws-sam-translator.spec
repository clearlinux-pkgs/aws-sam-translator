...
Source0  : https://files.pythonhosted.org/packages/0c/98/c16af074d75feebdb909b0c6a028487d508e7b5001b68d228dcc4666e127/aws-sam-translator-1.47.0.tar.gz
...
%prep
%setup -q -n aws-sam-translator-1.47.0
cd %{_builddir}/aws-sam-translator-1.47.0
pushd ..
cp -a aws-sam-translator-1.47.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657720287
...
cp %{_builddir}/aws-sam-translator-1.47.0/LICENSE %{buildroot}/usr/share/package-licenses/aws-sam-translator/9ff23d505de81a8185554e10c611378b8698bc71
