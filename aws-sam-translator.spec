...
Source0  : https://files.pythonhosted.org/packages/b1/ce/402ea474888505f956bba9a5b224d2662d5a4071925ad38079eb3506bd90/aws-sam-translator-1.45.0.tar.gz
...
%prep
%setup -q -n aws-sam-translator-1.45.0
cd %{_builddir}/aws-sam-translator-1.45.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649275330
...
cp %{_builddir}/aws-sam-translator-1.45.0/LICENSE %{buildroot}/usr/share/package-licenses/aws-sam-translator/9ff23d505de81a8185554e10c611378b8698bc71
