...
Source0  : https://files.pythonhosted.org/packages/9c/4a/b301045f4404dbaca14845472f28a0b80f48692e1b39420931a8e8c6f30d/aws-sam-translator-1.44.0.tar.gz
...
%prep
%setup -q -n aws-sam-translator-1.44.0
cd %{_builddir}/aws-sam-translator-1.44.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648650380
...
cp %{_builddir}/aws-sam-translator-1.44.0/LICENSE %{buildroot}/usr/share/package-licenses/aws-sam-translator/9ff23d505de81a8185554e10c611378b8698bc71
