...
Source0  : https://files.pythonhosted.org/packages/40/85/f0eecd063a65de84f944c6a020ca3599b9d3c08efc9d856991bc76e20326/aws-sam-translator-1.43.0.tar.gz
...
%prep
%setup -q -n aws-sam-translator-1.43.0
cd %{_builddir}/aws-sam-translator-1.43.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648143713
...
cp %{_builddir}/aws-sam-translator-1.43.0/LICENSE %{buildroot}/usr/share/package-licenses/aws-sam-translator/9ff23d505de81a8185554e10c611378b8698bc71
